...
for LED_scenario in LED_scenarios:
    ...
    if reduce_supplypenaltyBEV:
        ...
        Scen_CarSegments, Cost_Data = change_supply_penalty_BEV(Scen_CarSegments, Cost_Data, Technology, years,
                                                                shift_yrs=0, multiplier1=1.8, multiplier2=1.6,
                                                                multiplier3=0.6, multiplier4=-4, y1=8, y2=14, y3=16)

    if reduce_supplypenaltyPHEV:
        print('Adjusting PHEV supply penalty')
        Scen_CarSegments, Cost_Data = change_supply_penalty_PHEV(Scen_CarSegments, Cost_Data, Technology, years,
                                                                 shift_yrs=0, multiplier1=1, multiplier2=0.3,
                                                                 multiplier3=0.2, y1=5, y2=12, phase_out_date=2035)

    if reduce_supplypenaltyHEV:
        print('Adjusting HEV supply penalty')
        Scen_CarSegments, Cost_Data = change_supply_penalty_HEV(Scen_CarSegments, Cost_Data, Technology, years,
                                                                shift_yrs=0, multiplier1=2, multiplier2=1.8,
                                                                multiplier3=2, y1=6, y2=11, phase_out_date=2030)

    if increase_supplypenaltyPetrol:
        print('Adjusting Petrol supply penalty')
        Scen_CarSegments, Cost_Data = change_supply_penalty_Petrol(Scen_CarSegments, Cost_Data, Technology, years,
                                                                   shift_yrs=0, multiplier1=0.4, multiplier2=1.2,
                                                                   multiplier3=2.5, y1=10, y2=13, phase_out_date=2030)

    if increase_supplypenaltyDiesel:
        print('Adjusting Diesel supply penalty')
        Scen_CarSegments, Cost_Data = change_supply_penalty_Diesel(Scen_CarSegments, Cost_Data, Technology, years,
                                                                   shift_yrs=0, multiplier1=0.5, multiplier2=1.2,
                                                                   multiplier3=2.5, y1=9, y2=14, phase_out_date=2030)
    ...
    # Define new dataframes for Utility/MarketSh, SumNewCars/MarketShTotal, NewCars, TotalCars
    ...
    Sizes = [1, 2, 3]
    Charging_Access_Levels = [0, 1, 2]  # not aware of EV incentives, aware and access to charging, aware but no access
